A <- read.csv("/Users/reagan/Desktop/final_mission/m6a_result_shark&std/f1.csv", header = T)
library(ggplot2)
library(ggsci)
...
ggplot()+
  ...
  annotate(geom = 'text', label="F1", x=5.5, y=1.157, size=10)+
