...
def main(sequence):
    ...
    parser.add_argument(
        "--model_path",
        default="/Users/reagan/Desktop/3UTRBERT_visualiztion/saliency_based_color_background/3-new-12w-0_a",
        type=str,
    ...
    #display(HTML(text))
    with open("/Users/reagan/Desktop/visualization.html", "w") as file:
        file.write(text)
...
if __name__ == "__main__":
    ...
    sequence = "GCGGUGCGAGGCCCGGCGGCGUCGGCUGAGGGACCAGCGGGACUGGGGCGAACCCGGCGUGGGCCGAGCCUUGGAGCUCGGGCGUCGGGUCACCGCGUCC"
    attention = main(sequence)
    print(attention)
